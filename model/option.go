...
func InitOptionMap() {
	...
	common.OptionMap["RetryOnEmptyResponse"] = strconv.FormatBool(operation_setting.RetryOnEmptyResponse)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "InvitationCodeRequired" || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "RetryOnEmptyResponse":
			operation_setting.RetryOnEmptyResponse = boolValue
