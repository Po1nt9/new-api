...
function getCopyableCode(invitationCode: InvitationCode): string {
  return invitationCode.code || invitationCode.code_prefix
}
            ...
            <div className='flex min-w-0 items-start justify-between gap-3'>
              <div className='min-w-0'>
                ...
                <button
                  ...
                  onClick={() => copyToClipboard(getCopyableCode(invitationCode))}
                  aria-label={t('Click to copy')}
                  className='text-muted-foreground hover:text-primary inline-flex max-w-full items-center gap-1 truncate font-mono text-xs transition-colors'
                >
